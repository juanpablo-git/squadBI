...
export default ()=> 
<div style={{width:"100%",minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",marginTop:"100px"}}>
<div style={{width:"80%",}} >

<DivText  >
    <Text>
        <ContainerTitle><h2>Conheça nossas outras soluções</h2></ContainerTitle>
    </Text>
</DivText>
